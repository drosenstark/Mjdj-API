...
class UiRow extends JPanel {
	JComboBox<String> leftBox;
	JComboBox<String> rightBox;
	JLabel label;
	Ui ui;
	...
	public UiRow(Ui ui, List<String> inDevices, List<String> outDevices) {
		...
		leftBox = new JComboBox<String>(inDevices.toArray(new String[inDevices.size()]));
		rightBox = new JComboBox<String>(outDevices.toArray(new String[outDevices.size()]));
	...
	private boolean addItemIfDoesNotContain(JComboBox<String> box, String lookingFor) {
